    ...
    <div class="w3-main topmargin" method="POST">
        ...
        <div class="w3-panel">
            <div class="w3-third border">
                <img src="http://ak2.polyvoreimg.com/cgi/img-thing/size/l/tid/193538537.jpg" style="width:48%">
            </div>
            <div class="w3-twothird border" style="padding: 10px">
                <p name="item15">Choies Pink Short Sleeve Metallic Velvet Shift Dress</p>
                <p>Price: $125</p>
                <?php
                    ...
                    $sqlstock = "SELECT stock_quantity FROM stock_tbl WHERE stock_id='15'";
        ...
        <div class="w3-panel">
            ...
            <?php
                ...
                $sql = "SELECT * FROM item15_tbl ORDER BY id DESC";
        ...
        <div class="w3-panel">
            ...
            <form action="item15review.php" method="GET">
                Name<br>
