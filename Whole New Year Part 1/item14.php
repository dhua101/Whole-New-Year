    ...
    <div class="w3-main topmargin" method="POST">
        ...
        <div class="w3-panel">
            <div class="w3-third border">
                <img src="http://ak2.polyvoreimg.com/cgi/img-thing/size/l/tid/190152679.jpg" style="width:48%">
            </div>
            <div class="w3-twothird border" style="padding: 10px">
                <p name="item14">MSGM ruffled velvet dress</p>
                <p>Price: $355</p>
                <?php
        ...
        <div class="w3-panel">
            ...
            <form action="item14review.php" method="GET">
                Name<br>
