...
<body>
    ...
    <div class="w3-top">
        <ul class="w3-navbar w3-white w3-left-align">
            ...
            <li class="w3-hide-small w3-right"><a href="contactmember.phtml" class="w3-hover-yellow" title="Help"><i class="fa fa-question-circle" id="help"></i> Help</a></li>
            <li class="w3-hide-small w3-right"><a href="shoppingcartmember.php" class="w3-hover-yellow" title="Shopping Cart"><i class="fa fa-shopping-cart"></i></a></li>
            <div class="w3-center" style="margin-top:50px; margin-right:0px;">
                Welcome
                <?php
        ...
        <div class="w3-panel bordernoback">
            <div class="w3-row">
                ...
                <div class="w3-col m2">
                    <div class="w3-card">
                        <div class="card-block">
                            <img src="http://demandware.edgesuite.net/sits_pod20-adidas/dw/image/v2/aaqx_prd/on/demandware.static/-/Sites-adidas-products/default/dw388cadfd/zoom/B10602_21_model.jpg?sw=500&sfrm=jpg" style="width:90%">
                ...
                <div class="w3-col m2">
                    <div class="w3-card">
                        <div class="card-block">
                            <img src="http://shoptommy.scene7.com/is/image/ShopTommy/WW17392_901_FNT?wid=218&hei=326&fmt=jpeg&qlt=90%2c0&op_sharpen=1&resMode=trilin&op_usm=0.8%2c1.0%2c6%2c0&iccEmbed=0&cropN=0.165,0,0.67,1" style="width:60%">
                ...
                <div class="w3-col m2">
                    <div class="w3-card">
                        <div class="card-block">
                            <img src="http://shoptommy.scene7.com/is/image/ShopTommy/DW01231_078_BCK?wid=218&hei=326&fmt=jpeg&qlt=90%2c0&op_sharpen=1&resMode=trilin&op_usm=0.8%2c1.0%2c6%2c0&iccEmbed=0&cropN=0.165,0,0.67,1" style="width:60%">
            ...
            <div class="w3-row">
                ...
                <div class="w3-col m2">
                    <div class="w3-card">
                        <div class="card-block">
                            <div id="imagelist">
                                <a href="item172.php"><img src="http://images.nike.com/is/image/DotCom/PDP_COPY/727324_101/sportswear-windrunner-jacket.jpg" style="width:75%">
                                <p class="imgtext">
                                    <span>
                                        <span>Quick View</span>
                                    </span>
                ...
                <div class="w3-col m2">
                    <div class="w3-card">
                        <div class="card-block">
                            <img src="http://images.nike.com/is/image/DotCom/PDP_COPY/777269_421/fc-barcelona-sportswear-authentic-n98-track-jacket.jpg" style="width:75%">
                ...
                <div class="w3-col m2">
                    <div class="w3-card">
                        <div class="card-block">
                            <img src="http://demandware.edgesuite.net/sits_pod20-adidas/dw/image/v2/aaqx_prd/on/demandware.static/-/Sites-adidas-products/default/dwa8b868d7/zoom/S99320_21_model.jpg?sw=500&sfrm=jpg" style="width:75%">
                ...
                <div class="w3-col m2">
                    <div class="w3-card">
                        <div class="card-block">
                            <img src="http://demandware.edgesuite.net/sits_pod20-adidas/dw/image/v2/aaqx_prd/on/demandware.static/-/Sites-adidas-products/default/dwb63ad037/zoom/AY0085_21_model.jpg?sw=500&sfrm=jpg" style="width:75%">
        ...
        <div class="w3-panel">
            ...
            <div class="w3-quarter leftborder">
                <div class="w3-half">
                    ...
                    <div class="w3-panel w3-center bottomborder">
                        <a href="contactmember.phtml">Contact</a>
                    </div>
                </div>
