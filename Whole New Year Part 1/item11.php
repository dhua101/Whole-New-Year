    ...
    <div class="w3-main topmargin" method="POST">
        ...
        <div class="w3-panel">
            <div class="w3-third border">
                <img src="http://images.nike.com/is/image/DotCom/pwp_sheet2?$NIKE_PWPx3$&$img0=835384_012&$img1=835384_658&$img2=835384_061" style="width:48%">
            </div>
            <div class="w3-twothird border" style="padding: 10px">
                <p name="item11">Nike Therma Elite Pants</p>
                <p>Price: $70</p>
                <?php
        ...
        <div class="w3-panel">
            ...
            <form action="item11review.php" method="GET">
                Name<br>
