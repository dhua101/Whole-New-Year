<!-- application/views/scripts/index/shoppingcartmember.phtml -->
...
<body>
    ...
    <div class="w3-main topmargin" method="POST">
        <ul class="w3-blue w3-navbar w3-left-align">
            <li class="w3-hide-small"><a href="wholenewyearmember.phtml" class="w3-theme-d3">Home</a></li>
            <li class="w3-hide-small"><a href="#" class="w3-theme-d3  w3-hover-yellow">Catalog</a></li>
            <li class="w3-hide-small"><a href="#" class="w3-theme-d3  w3-hover-yellow">Catalog</a></li>
        ...
        <div class="w3-panel">
            ...
            <div class="w3-quarter border">
                <div class="w3-center">
                    ...
                    <a href="mastercard.phtml"><img src="https://usshortcodedirectory.com/wp-content/uploads/2016/03/www.mastercard.com_.png" name="mastercard"></a>
                    <a href="visa.phtml"><img src="https://cdn3.iconfinder.com/data/icons/flat-icons-web/40/Visa-128.png" name="visa"></a>
                </div>
            </div>
        </div>
    </div>
