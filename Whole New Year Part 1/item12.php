    ...
    <div class="w3-main topmargin" method="POST">
        ...
        <div class="w3-panel">
            <div class="w3-third border">
                <img src="http://images.nike.com/is/image/DotCom/pwp_sheet2?$NIKE_PWPx3$&$img0=807456_422&$img1=807456_387&$img2=807456_010" style="width:48%">
            </div>
            <div class="w3-twothird border" style="padding: 10px">
                <p name="item12">Nike Therma Sphere Element Hoodie</p>
                <p>Price: $100</p>
                <?php
        ...
        <div class="w3-panel">
            ...
            <form action="item12review.php" method="GET">
                Name<br>
