    ...
    <div class="w3-main topmargin" method="POST">
        ...
        <div class="w3-panel">
            <div class="w3-third border">
                <img src="http://pumaecom.scene7.com/is/image/PUMAECOM/514597_03_PNA?$PUMA_GRID$" style="width:49%">
            </div>
            <div class="w3-twothird border" style="padding: 10px">
                <p name="item3">PWRWARM Tech Fleece Pants</p>
                <p>Price: $44.99</p>
                <?php
                    ...
                    mysql_select_db("wholenewyear_db");
        ...
        <div class="w3-panel">
            ...
            <form action="item3review.php" method="GET">
                Name<br>
