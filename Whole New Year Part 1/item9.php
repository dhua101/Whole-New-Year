    ...
    <div class="w3-main topmargin" method="POST">
        ...
        <div class="w3-panel">
            <div class="w3-third border">
                <img src="http://images.nike.com/is/image/DotCom/pwp_sheet2?$NIKE_PWPx3$&$img0=802016_480&$img1=802016_065&$img2=802016_340" style="width:48%">
            </div>
            <div class="w3-twothird border" style="padding: 10px">
                <p name="item9">Nike Pro HyperWarm</p>
                <p>Price: $45</p>
                <?php
        ...
        <div class="w3-panel">
            ...
            <?php
                ...
                $sql = "SELECT * FROM item9_tbl ORDER BY id DESC";
        ...
        <div class="w3-panel">
            ...
            <form action="item9review.php" method="GET">
                Name<br>
