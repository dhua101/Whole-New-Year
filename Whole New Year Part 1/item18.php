    ...
    <div class="w3-main topmargin" method="POST">
        ...
        <div class="w3-panel">
            <div class="w3-third border">
                <img src="http://demandware.edgesuite.net/sits_pod20-adidas/dw/image/v2/aaqx_prd/on/demandware.static/-/Sites-adidas-products/default/dwb63ad037/zoom/AY0085_21_model.jpg?sw=500&sfrm=jpg" style="width:48%">
            </div>
            <div class="w3-twothird border" style="padding: 10px">
                <p name="item18">Women's Climaheat Light Jacket</p>
                <p>Price: $300</p>
                <?php
                    ...
                    $sqlstock = "SELECT stock_quantity FROM stock_tbl WHERE stock_id='18'";
        ...
        <div class="w3-panel">
            ...
            <?php
                ...
                $sql = "SELECT * FROM item18_tbl ORDER BY id DESC";
        ...
        <div class="w3-panel">
            ...
            <form action="item18review.php" method="GET">
                Name<br>
