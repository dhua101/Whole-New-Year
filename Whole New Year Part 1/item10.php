    ...
    <div class="w3-main topmargin" method="POST">
        ...
        <div class="w3-panel">
            <div class="w3-third border">
                <img src="http://images.nike.com/is/image/DotCom/pwp_sheet2?$NIKE_PWPx3$&$img0=835379_658&$img1=835379_012&$img2=835379_420" style="width:48%">
            </div>
            <div class="w3-twothird border" style="padding: 10px">
                <p name="item10">Nike Therma Elite Hoodies</p>
                <p>Price: $80</p>
                <?php
        ...
        <div class="w3-panel">
            ...
            <form action="item10review.php" method="GET">
                Name<br>
