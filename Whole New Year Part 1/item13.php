    ...
    <div class="w3-main topmargin" method="POST">
        ...
        <div class="w3-panel">
            <div class="w3-third border">
                <img src="http://ak1.polyvoreimg.com/cgi/img-thing/size/l/tid/187991967.jpg" style="width:48%">
            </div>
            <div class="w3-twothird border" style="padding: 10px">
                <p name="item13">Unreal Fur Pastoral Aqua Ombre Faux Fur Jacket</p>
                <p>Price: $180</p>
                <?php
        ...
        <div class="w3-panel">
            ...
            <form action="item13review.php" method="GET">
                Name<br>
