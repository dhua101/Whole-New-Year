    ...
    <div class="w3-main topmargin" method="POST">
        ...
        <div class="w3-panel">
            <div class="w3-third border">
                <img src="http://pumaecom.scene7.com/is/image/PUMAECOM/514565_03_PNA?$PUMA_GRID$" style="width:49%">
            </div>
            <div class="w3-twothird border" style="padding: 10px">
                <p name="item1">PWRWARM Fleece Hoodie</p>
                <p>Price: $39.99</p>
                <?php
        ...
        <div class="w3-panel">
            ...
            <form action="item1review.php" method="GET">
                Name<br>
