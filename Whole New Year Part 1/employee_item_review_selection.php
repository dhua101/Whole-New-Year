...
<?php
    ...
    if(isset($_POST['item1'])) {
        $sqlitemreview = "SELECT * FROM item1_tbl";
    } else if(isset($_POST['item2'])) {
        $sqlitemreview = "SELECT * FROM item2_tbl";
    } else if(isset($_POST['item3'])) {
        $sqlitemreview = "SELECT * FROM item3_tbl";
    } else if(isset($_POST['item4'])) {
        $sqlitemreview = "SELECT * FROM item4_tbl";
    } else if(isset($_POST['item5'])) {
        $sqlitemreview = "SELECT * FROM item5_tbl";
    } else if(isset($_POST['item6'])) {
        $sqlitemreview = "SELECT * FROM item6_tbl";
    } else if(isset($_POST['item7'])) {
        $sqlitemreview = "SELECT * FROM item7_tbl";
    } else if(isset($_POST['item8'])) {
        $sqlitemreview = "SELECT * FROM item8_tbl";
    } else if(isset($_POST['item9'])) {
        $sqlitemreview = "SELECT * FROM item9_tbl";
    } else if(isset($_POST['item10'])) {
        $sqlitemreview = "SELECT * FROM item10_tbl";
    } else if(isset($_POST['item11'])) {
        $sqlitemreview = "SELECT * FROM item11_tbl";
    } else if(isset($_POST['item12'])) {
        $sqlitemreview = "SELECT * FROM item12_tbl";
    } else if(isset($_POST['item13'])) {
        $sqlitemreview = "SELECT * FROM item13_tbl";
    } else if(isset($_POST['item14'])) {
        $sqlitemreview = "SELECT * FROM item14_tbl";
    } else if(isset($_POST['item15'])) {
        $sqlitemreview = "SELECT * FROM item15_tbl";
    } else if(isset($_POST['item16'])) {
        $sqlitemreview = "SELECT * FROM item16_tbl";
    } else if(isset($_POST['item17'])) {
        $sqlitemreview = "SELECT * FROM item17_tbl";
    } else if(isset($_POST['item18'])) {
        $sqlitemreview = "SELECT * FROM item18_tbl";
    } else if(isset($_POST['item19'])) {
        $sqlitemreview = "SELECT * FROM item19_tbl";
    } else if(isset($_POST['item20'])) {
        $sqlitemreview = "SELECT * FROM item20_tbl";
    } else if(isset($_POST['item21'])) {
        $sqlitemreview = "SELECT * FROM item21_tbl";
    }

    $sqlitemreviewquery = mysql_query($sqlitemreview, $connection);

    echo "<tr><th style='border:1px solid black'>Review ID</th><th style='border:1px solid black'>Name</th><th style='border:1px solid black'>Rating</th><th style='border:1px solid black'>Comment</th><th style='border:1px solid black'>Date Entered</th></tr>";

    while($row = mysql_fetch_assoc($sqlstockquery, MYSQL_ASSOC)) {
        echo "<tr>";
        echo "<td style='border:1px solid black'>" . $row['id'] . "</td><td style='border:1px solid black'>" . $row['name'] . "</td><td style='border:1px solid black'>" . $row['rating'] . "</td><td style='border:1px solid black'>" . $row['comment'] . "</td><td style='border:1px solid black'>" . $row['entered'] . "</td>";
        echo "</tr>";
    }
