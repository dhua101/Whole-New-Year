    ...
    <div class="w3-main topmargin" method="POST">
        ...
        <div class="w3-panel">
            <div class="w3-third border">
                <img src="http://pumaecom.scene7.com/is/image/PUMAECOM/838646_01_PNA?$PUMA_GRID$" style="width:48%">
            </div>
            <div class="w3-twothird border" style="padding: 10px">
                <p name="item6">ACTIVE 600 PackLITE Down Jacket</p>
                <p>Price: $74.99</p>
                <?php
        ...
        <div class="w3-panel">
            ...
            <?php
                ...
                $sql = "SELECT * FROM item6_tbl ORDER BY id DESC";
        ...
        <div class="w3-panel">
            ...
            <form action="item6review.php" method="GET">
                Name<br>
