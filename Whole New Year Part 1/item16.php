    ...
    <div class="w3-main topmargin" method="POST">
        ...
        <div class="w3-panel">
            <div class="w3-third border">
                <img src="http://demandware.edgesuite.net/sits_pod20-adidas/dw/image/v2/aaqx_prd/on/demandware.static/-/Sites-adidas-products/default/dw388cadfd/zoom/B10602_21_model.jpg?sw=500&sfrm=jpg" style="width:48%">
            </div>
            <div class="w3-twothird border" style="padding: 10px">
                <p name="item16">Men's Germany Training Pants</p>
                <p>Price: $70</p>
                <?php
                    ...
                    $sqlstock = "SELECT stock_quantity FROM stock_tbl WHERE stock_id='16'";
        ...
        <div class="w3-panel">
            ...
            <?php
                ...
                $sql = "SELECT * FROM item16_tbl ORDER BY id DESC";
        ...
        <div class="w3-panel">
            ...
            <form action="item16review.php" method="GET">
                Name<br>
