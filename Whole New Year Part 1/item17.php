    ...
    <div class="w3-main topmargin" method="POST">
        ...
        <div class="w3-panel">
            <div class="w3-third border">
                <img src="http://demandware.edgesuite.net/sits_pod20-adidas/dw/image/v2/aaqx_prd/on/demandware.static/-/Sites-adidas-products/default/dwa8b868d7/zoom/S99320_21_model.jpg?sw=500&sfrm=jpg" style="width:48%">
            </div>
            <div class="w3-twothird border" style="padding: 10px">
                <p name="item17">Women's adidas Reigning Champ Fleece Jacket</p>
                <p>Price: $150</p>
                <?php
                    ...
                    $sqlstock = "SELECT stock_quantity FROM stock_tbl WHERE stock_id='17'";
        ...
        <div class="w3-panel">
            ...
            <?php
                ...
                $sql = "SELECT * FROM item17_tbl ORDER BY id DESC";
                ...
                <div class='w3-panel'>
                    ...
                    <div class='w3-quarter'>
                        <br>
                        5 Stars
                        <div class='w3-progress-container' style='width:250px'>
        ...
        <div class="w3-panel">
            ...
            <form action="item17review.php" method="GET">
                Name<br>
