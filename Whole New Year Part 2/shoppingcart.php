<!-- application/views/scripts/index/shoppingcart.phtml -->
...
<body>
    ...
    <div class="w3-top">
        <ul class="w3-navbar w3-white w3-left-align">
            ...
            <li class="w3-hide-small w3-right"><a href="#" class="w3-hover-yellow">Sign In</a></li>
        </ul>
    ...
    <div class="w3-main topmargin" method="POST">
        <ul class="w3-blue w3-navbar w3-left-align">
            <li class="w3-hide-small"><a href="wholenewyear.phtml" class="w3-theme-d3">Home</a></li>
        ...
        <div class="w3-panel">
            ...
            <div class="w3-quarter border">
                <div class="w3-center">
                    ...
                    <a href="mastercard.php"><img src="https://usshortcodedirectory.com/wp-content/uploads/2016/03/www.mastercard.com_.png" name="mastercard"></a>
                    <a href="visa.php"><img src="https://cdn3.iconfinder.com/data/icons/flat-icons-web/40/Visa-128.png" name="visa"></a>
                </div>
            </div>
        </div>
    </div>
