    ...
    <div class="w3-main topmargin" method="POST">
        ...
        <div class="w3-panel">
            <div class="w3-third border">
                <img src="http://images.nike.com/is/image/DotCom/pwp_sheet2?$NIKE_PWPx3$&$img0=805144_423&$img1=805144_010&$img2=805144_011" style="width:48%">
            </div>
            <div class="w3-twothird border" style="padding: 10px">
                <p name="item7">Nike Sportswear Tech Fleece Windrunner</p>
                <p>Price: $130</p>
                <?php
        ...
        <div class="w3-panel">
            ...
            <?php
                ...
                $sql = "SELECT * FROM item7_tbl ORDER BY id DESC";
        ...
        <div class="w3-panel">
            ...
            <form action="item7review.php" method="GET">
                Name<br>
