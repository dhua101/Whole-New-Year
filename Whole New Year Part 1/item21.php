    ...
    <div class="w3-main topmargin" method="POST">
        ...
        <div class="w3-panel">
            <div class="w3-third border">
                <img src="http://images.nike.com/is/image/DotCom/PDP_COPY/777269_421/fc-barcelona-sportswear-authentic-n98-track-jacket.jpg" style="width:48%">
            </div>
            <div class="w3-twothird border" style="padding: 10px">
                <p name="item21">FC Barcelona Nike Sportswear Authentic N98</p>
                <p>Price: $120</p>
                <?php
        ...
        <div class="w3-panel">
            ...
            <?php
                ...
                $sql = "SELECT * FROM item21_tbl ORDER BY id DESC";
        ...
        <div class="w3-panel">
            ...
            <form action="item21review.php" method="GET">
                Name<br>
