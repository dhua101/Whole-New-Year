    ...
    <div class="w3-main topmargin" method="POST">
        ...
        <div class="w3-panel">
            <div class="w3-third border">
                <img src="http://pumaecom.scene7.com/is/image/PUMAECOM/514599_03_PNA?$PUMA_GRID$" style="width:48%">
            </div>
            <div class="w3-twothird border" style="padding: 10px">
                <p name="item4">PWRWARM Tech Zip-Up Fleece</p>      
                <p>Price: $49.99</p>
                <?php
        ...
        <div class="w3-panel">
            ...
            <form action="item4review.php" method="GET">
                Name<br>
