    ...
    <div class="w3-main topmargin" method="POST">
        ...
        <div class="w3-panel">
            <div class="w3-third border">
                <img src="http://shoptommy.scene7.com/is/image/ShopTommy/WW17392_901_FNT?wid=218&hei=326&fmt=jpeg&qlt=90%2c0&op_sharpen=1&resMode=trilin&op_usm=0.8%2c1.0%2c6%2c0&iccEmbed=0&cropN=0.165,0,0.67,1" style="width:48%">
            </div>
            <div class="w3-twothird border" style="padding: 10px">
                <p name="item20">Sequin Stripe Sweater Gigi Hadid</p>
                <p>Price: $199.50</p>
                <?php
                    ...
                    $sqlstock = "SELECT stock_quantity FROM stock_tbl WHERE stock_id='20'";
                    ...
                    if($stock['stock_quantity'] != 0) {
                        ...
                        echo '
                            <form action="cart.php"method="get">
                                Quantity: 
                                <input type="text" name="quantity20" style="width:50px" id="quantity20"><br>
                                <input type="submit" name="submit" value="Add to Cart" id="item20">
                            </form>';
                    } else {
        ...
        <div class="w3-panel">
            ...
            <?php
                ...
                $sql = "SELECT * FROM item20_tbl ORDER BY id DESC";
        ...
        <div class="w3-panel">
            ...
            <form action="item20review.php" method="GET">
                Name<br>
