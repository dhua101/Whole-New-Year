    ...
    <div class="w3-main topmargin" method="POST">
        ...
        <div class="w3-panel">
            <div class="w3-third border">
                <img src="http://www.polyvore.com/cgi/img-thing?.out=jpg&size=l&tid=6676616" style="width:48%">
            </div>
            <div class="w3-twothird border" style="padding: 10px">
                <p name="item23">Pink full lace skirt</p>
                <p>Price: $250</p>
                <?php
        ...
        <div class="w3-panel">
            ...
            <form action="item23review.php" method="GET">
                Name<br>
