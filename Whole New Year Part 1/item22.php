    ...
    <div class="w3-main topmargin" method="POST">
        ...
        <div class="w3-panel">
            <div class="w3-third border">
                <img src="http://www.polyvore.com/cgi/img-thing?.out=jpg&size=l&tid=69465588" style="width:48%">
            </div>
            <div class="w3-twothird border" style="padding: 10px">
                <p name="item22">DICE KAYEK PLEATED BOW PANEL SKIRT</p>
                <p>Price: $165</p>
                <?php
                    ...
                    $sqlstock = "SELECT stock_quantity FROM stock_tbl WHERE stock_id='21'";
                    ...
                    if($stock['stock_quantity'] != 0) {
                        ...
                        echo '
                            <form action="cart.php"method="get">
                                Quantity: 
                                <input type="text" name="quantity21" style="width:50px" id="quantity21"><br>
        ...
        <div class="w3-panel">
            ...
            <form action="item22review.php" method="GET">
                Name<br>
